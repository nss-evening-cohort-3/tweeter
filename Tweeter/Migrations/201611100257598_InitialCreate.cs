    ...
    public partial class InitialCreate : DbMigration
    {
        public override void Up()
        {
            ...
            CreateTable(
                ...
                c => new
                    {
                        TwerpId = c.Int(nullable: false, identity: true),
                        Message = c.String(),
                        ImgUrl = c.String(),
                ...
                .PrimaryKey(t => t.TwerpId)
                .ForeignKey("dbo.Twits", t => t.Author_TwitId)
                .ForeignKey("dbo.Twerps", t => t.Twerp_TwerpId)
                .Index(t => t.Author_TwitId)
                .Index(t => t.Twerp_TwerpId);
        ...
        {
            DropForeignKey("dbo.Twerps", "Twerp_TwerpId", "dbo.Twerps");
            DropForeignKey("dbo.Twerps", "Author_TwitId", "dbo.Twits");
            ...
            DropIndex("dbo.Twerps", new[] { "Twerp_TwerpId" });
            DropIndex("dbo.Twerps", new[] { "Author_TwitId" });
